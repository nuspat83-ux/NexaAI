...
export interface BuilderState{creationMode:CreationMode;directBrief:string;businessDetails:Record<string,string>;category:string;customBusiness:string;businessName:string;tagline:string;description:string;location:string;phone:string;whatsapp:string;email:string;address:string;hours:string;socials:string;existingWebsite:string;styles:string[];primary:string;secondary:string;font:string;theme:'light'|'dark'|'ai';sections:string[];pages:string[];features:string[];assets:Asset[];brief:string;audience:string;plan:string;}
